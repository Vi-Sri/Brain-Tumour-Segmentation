...
IMG_ROOT = './Task01_BrainTumour/imagesTr'
IMG_PATH = './Task01_BrainTumour/imagesTr/BRATS_148.nii.gz'
IMG_OUTPUT_ROOT = './train/image_T1'

LABEL_ROOT = './Task01_BrainTumour/labelsTr'
IABEL_PATH = './Task01_BrainTumour/labelsTr/BRATS_148.nii.gz'
...
def nii2jpg_img(img_path, output_root):
    ...
    for i in range(img.shape[3]):
        img_channel = img[:,:,:,i]
        img_channel = (img_channel - img_channel.min()) / (img_channel.max() - img_channel.min())
        img[:,:,:,i] = img_channel * 255
